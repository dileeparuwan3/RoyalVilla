...
namespace RoyalVilla_API.Controllers
{
    ...
    public class VillaController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<IEnumerable<VillaDTO>>>> GetVillas()
        {
            ...
            var response = ApiResponse<IEnumerable<VillaDTO>>.Ok(dtoResponseVilla, "Villas retieved successfully");
        ...
        public async Task<ActionResult<ApiResponse<VillaDTO>>> UpdateVilla(int id, VillaUpdateDTO villaDTO)
        {
            try
            {
                ...
                if (villaDTO.Id != id)
                {
                    return BadRequest(ApiResponse<object>.BadRequest("Villa ID in URL does not match the Villa ID in the request body"));
        ...
        public async Task<ActionResult<ApiResponse<object>>> DeleteVilla(int id)
        {
            try
            {
                ...
                var response = ApiResponse<object>.NotContent("Villa deleted successfully");
                return Ok(response);
